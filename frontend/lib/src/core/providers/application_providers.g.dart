...
String _$getSessionHash() => r'34cccc34c97b5af39b3c8a897fd8fbbd5e246b5b';

/// See also [getSession].
@ProviderFor(getSession)
final getSessionProvider = FutureProvider<UserModel>.internal(
  getSession,
  name: r'getSessionProvider',
  debugGetCreateSourceHash:
      const bool.fromEnvironment('dart.vm.product') ? null : _$getSessionHash,
  dependencies: null,
  allTransitiveDependencies: null,
);

typedef GetSessionRef = FutureProviderRef<UserModel>;
...
String _$getBarbershopHash() => r'080e5571cf844659aa827ed0093f66cb0dc9a561';

/// See also [getBarbershop].
@ProviderFor(getBarbershop)
final getBarbershopProvider = FutureProvider<BarbershopModel>.internal(
  getBarbershop,
  name: r'getBarbershopProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$getBarbershopHash,
  dependencies: null,
...
typedef GetBarbershopRef = FutureProviderRef<BarbershopModel>;
String _$logoutHash() => r'862917b602d80bd9c65670b60b095b01d97d659f';
