...
class AuthInterceptor extends Interceptor {
  ...
  void onRequest(
    ...
    if (extra case {'DIO_AUTH_KEY': true}) {
      // nesta linha ocorre a mesma coisa de utilizar um containskey e verificar se a key tem o valor true
  ...
  void onError(DioException err, ErrorInterceptorHandler handler) {
    ...
    handler.reject(err); //somos obrigados a rejeitar a requisição para que nao fique em looping.
  }
}
